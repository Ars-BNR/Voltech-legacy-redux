...
const StatusCancelUser = () => {
    return (
        <div className={classes.statusOrderBlock__status_StatusCancel}>Отменен пользователем</div>
    );
};
const OrdersInfo = () => {
                            ...
                            <div key={elother.id_order} className={classes.ordersItem}>
                                ...
                                <div className={classes.equipmentOrderBlock}>
                                    <p className={classes.equipmentOrderBlock__count}>
                                        {elother.allCount}{" "}
                                        {RenderPhrase(elother.allCount)}
                                    </p>
                                    <div className={classes.equipmentsList}>
                                        {elother.info &&
                                            elother.info.map((item, index) => (<div key={`${item.idBasket}_${index}`} className={classes.equipmentsList__item}>
                                                {item && (
                                                ...
                                                <p className={classes.equipmentsList__price}>
                                                    {item.equipment.price.toLocaleString('ru-RU')} <span className="rub">₽</span>
                                                </p>
                                            </div>
                                            )
                                            )}
